...
function LandingPadDetailsContent(props) {
    ...
    return (
        <div className="info-block">
            ...
            <p><span className="info-text-heading">Location: </span>{landingPad.location?.name}, {landingPad.location?.region}</p>
            <p><span className="info-text-heading">Location: </span>Lat. {landingPad.location?.latitude} Long. {landingPad.location?.longitude}</p>
            ...
            <p><span className="info-text-heading">Landing success rate: </span>{ landingPad.attempted_landings > 0 ? ((landingPad.successful_landings / landingPad.attempted_landings) * 100).toFixed(2) + '%' : '-' } </p>
